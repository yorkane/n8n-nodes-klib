...
import { FsOperate } from './nodes/FsOperate/FsOperate.node';
import { JiebaSegment } from './nodes/Jieba/JiebaSegment.node';
import * as utils from './lib/utils';

export const nodes = [ImageProcessor, Aria2, Aria2Proc, TorrentParse, FsUtils, FsOperate, JiebaSegment];
